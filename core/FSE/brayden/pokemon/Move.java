...
public class Move {
	...
	public static Move VineWhip = new Move("VINEWHIP",Type.GRASS,Category.PHYSICAL, 45f);
	...
	public static Move WaterPulse = new Move("WATERPULSE",Type.NORMAL,Category.PHYSICAL,50f);
